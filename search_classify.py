...
#writeUp_output = 'output_videos/' + input_video.split('.mp4')[0] + '_output' + '.mp4'
writeUp_output = 'project_video_output.mp4'

#clip = VideoFileClip(input_video).subclip(10,12)
clip = VideoFileClip(input_video)

writeUp_clip = clip.fl_image(find_cars)

writeUp_clip.write_videofile(writeUp_output, audio=False)
